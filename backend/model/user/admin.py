...
class Admin(User):
    def __init__(self, username: str, password_hash: str, personal_info: PersonalInfo, role: UserRole, is_archived=False):
        """
        ...
        """
        super().__init__(username, password_hash, personal_info, UserRole.ADMIN, is_archived=is_archived)
