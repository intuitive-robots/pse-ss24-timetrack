...
class Secretary(User):
    def __init__(self, username: str, password_hash: str,
             personal_info: PersonalInfo, slack_id: str = None, current_timesheet_ids=None):
        """
        ...
        """
        super().__init__(username, password_hash, personal_info, UserRole.SECRETARY, slack_id)
