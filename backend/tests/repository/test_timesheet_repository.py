...
class TestTimesheetRepository(unittest.TestCase):
    ...
    def test_get_timesheets_by_username_status(self):
        ...
        test_timesheet_data = [{'_id': ObjectId('6679ca2935df0d8f7202c5fa'),
                                  ...
                                  'username': 'testHiwi1',
                                  'year': 2024},
                                 {'_id': ObjectId('66b90500b0c42af95db0a37b'),
                                  'lastSignatureChange': datetime.datetime(2024, 8, 11, 20, 37, 40, 777000),
                                  'month': 10,
                                  'overtime': 0.0,
                                  'status': 'Not Submitted',
                                  'totalTime': 0.0,
                                  'username': 'testHiwi1',
                                  'year': 2024},
                                 {'_id': ObjectId('66b90554ba2c94390d68b421'),
                                  'lastSignatureChange': datetime.datetime(2024, 8, 11, 20, 39, 8, 609000),
                                  'month': 11,
                                  'overtime': 0.0,
                                  'status': 'Not Submitted',
                                  'totalTime': 0.0,
                                  'username': 'testHiwi1',
                                  'year': 2024},
                                 {'_id': ObjectId('66b9058bd96d2358040b6e06'),
                                  'lastSignatureChange': datetime.datetime(2024, 8, 11, 22, 40, 4, 611000),
                                  'month': 12,
                                  'overtime': 0.0,
                                  'status': 'Not Submitted',
                                  'totalTime': 0.0,
                                  'username': 'testHiwi1',
                                  'year': 2024},
                                 {'_id': ObjectId('66b905e5ccda6af91224ae48'),
                                  'lastSignatureChange': datetime.datetime(2024, 8, 11, 20, 41, 23, 268000),
                                  'month': 1,
                                  'overtime': 0.0,
                                  'status': 'Not Submitted',
                                  'totalTime': 0.0,
                                  'username': 'testHiwi1',
                                  'year': 2025},
                                 {'_id': ObjectId('66b9065e3a5ccdbeae428f4a'),
                                  'lastSignatureChange': datetime.datetime(2024, 8, 11, 20, 43, 36, 626000),
                                  'month': 2,
                                  'overtime': 0.0,
                                  'status': 'Not Submitted',
                                  'totalTime': 0.0,
                                  'username': 'testHiwi1',
                                  'year': 2025},
                                 {'_id': ObjectId('66b90710dbcbd47f232ef86c'),
                                  'lastSignatureChange': datetime.datetime(2024, 8, 11, 18, 46, 9, 99000),
                                  'month': 3,
                                  'overtime': 0.0,
                                  'status': 'Not Submitted',
                                  'totalTime': 0.0,
                                  'username': 'testHiwi1',
                                  'year': 2025},
                                 {'_id': ObjectId('66b9075edbcbd47f232ef86d'),
                                  'lastSignatureChange': datetime.datetime(2024, 8, 11, 18, 46, 9, 99000),
                                  'month': 4,
                                  'overtime': 0.0,
                                  'status': 'Not Submitted',
                                  ...
                                  'username': 'testHiwi1',
                                  'year': 2025},
                                 {'_id': ObjectId('66b907fa581dd71e216124d9'),
                                  'lastSignatureChange': datetime.datetime(2024, 8, 11, 18, 50, 27, 515000),
                                  'month': 5,
                                  'overtime': 0.0,
                                  'status': 'Not Submitted',
                                  'totalTime': 0.0,
                                  'username': 'testHiwi1',
                                  'year': 2025},
                                 {'_id': ObjectId('66b908d676835ad3591cc162'),
                                  'lastSignatureChange': datetime.datetime(2024, 8, 11, 18, 54, 14, 912000),
                                  'month': 6,
                                  'overtime': -4680.0,
                                  'status': 'Not Submitted',
                                  'totalTime': 120,
                                  'username': 'testHiwi1',
                                  'year': 2025},
                                 {'_id': ObjectId('66b9092aa023c636cecbbdfd'),
                                  'lastSignatureChange': '2024-08-11T20:54:46.325516+02:00',
                                  'month': 7,
                                  'overtime': 0.0,
                                  'status': 'Not Submitted',
                                  'totalTime': 0.0,
                                  'username': 'testHiwi1',
                                  'year': 2025},
                                 {'_id': ObjectId('66b9096d1033477de77dfa19'),
                                  'lastSignatureChange': datetime.datetime(2024, 8, 11, 18, 56, 45, 302000),
                                  'month': 8,
                                  'overtime': 0.0,
                                  'status': 'Not Submitted',
                                  'totalTime': 0.0,
                                  'username': 'testHiwi1',
                                  'year': 2025},
                                 {'_id': ObjectId('66b90f86eaecd2daf69ba359'),
                                  'lastSignatureChange': datetime.datetime(2024, 8, 11, 19, 22, 46, 141000),
                                  'month': 9,
                                  'overtime': 0.0,
                                  'status': 'Not Submitted',
                                  'totalTime': 0.0,
