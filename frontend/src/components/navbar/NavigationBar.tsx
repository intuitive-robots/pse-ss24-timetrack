...
const NavigationBar: React.FC = () => {
    ...
    return (
        <div className="flex flex-col w-72 h-full shadow-navbar-shadow border-r-2.7 border-border-gray">
            <div className="py-14 px-6 gap-6 flex flex-col font-semibold">
                        ...
                        {menuItems[section].map((item) => (
                            <button
                                ...
                                className={`text-left w-full py-1.5 px-4 rounded-md
                                            ${activeItem === item ? 'bg-navbar-selected-bg text-gray-800' : 'text-gray-600 hover:bg-navbar-selected-bg'}`}
