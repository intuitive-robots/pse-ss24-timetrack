    ...
    <div className="bg-white flex items-center py-5 px-10 shadow-profilebar-shadow border-b-2.7 border-border-gray font-semibold text-nowrap transition-all duration-300 ease-in-out ">
      <div className="flex items-center space-x-4">
        ...
        <div className="flex gap-3">
          <button
            disabled={true}
            className="btn border text-sm text-light-navGray h-full py-2 px-6 rounded-lg hidden md:flex"
          >
            This month
          </button>
          <button
            disabled={true}
            className="btn border text-sm text-light-navGray h-full py-2 px-6 rounded-lg hidden lg:flex"
          >
            By Project
          </button>
        </div>
      ...
      <div className="flex gap-2 items-center relative ml-auto md:pl-8 pl-2 transition-all duration-500 ease-in-out">
        ...
        {/*{isDropdownOpen && (*/}
        <div
          className={`absolute right-1 z-10 top-0 pt-14 w-64 bg-white rounded-xl shadow-profile-popup-shadow px-4 py-2 transform transition-all duration-100 ${
            isDropdownOpen
