...
const ProgressCard: React.FC<ProgressCardProps> = ({ currentValue, targetValue, label, unit = "", overtime = 0 }) => {
    ...
    const formattedOvertime = overtime < 0 ? `+${Math.abs(overtime)}` : `-${overtime}`;
