...
export const NotificationIconActive: React.FC<NotificationIconActiveProps> = ({className, circleColor = "#8A4FFF"}) => {
    return (
        <svg className={className} width="22" height="23" viewBox="0 0 22 23" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clipPath="url(#clip0_1259_42)">
                <path
            ...
            <circle cx="17" cy="5" r="5" fill={circleColor}/>
            <defs>
